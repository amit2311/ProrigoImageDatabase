...
$(document).ready(function() {
	...
	api.onError = ProrigoGallery.error
	...
	Mousetrap.bindGlobal([ 'esc', 'command+up' ], function() {
		...
		else if (visible.photo())                                                    ProrigoGallery.goto(album.getID())
		else if (visible.album())                                                    ProrigoGallery.goto()
	...
	$(document)
		...
		// Navigation
		.on('click', '.album', function() { ProrigoGallery.goto($(this).attr('data-id')) })
		.on('click', '.photo', function() { ProrigoGallery.goto(album.getID() + '/' + $(this).attr('data-id')) })
		...
		.on('drop', function(e) {
			...
			if (visible.photo())       ProrigoGallery.goto(album.getID())
