...
// Sub-implementation of ProrigoGallery -------------------------------------------------------------- //

let ProrigoGallery = {}

ProrigoGallery.content = $('.content')
...
const loadPhotoInfo = function(photoID) {
	...
	api.post('Photo::get', params, function(data) {
		...
		document.title = 'ProrigoGallery - ' + data.title
		header.dom('.header__title').html(ProrigoGallery.escapeHTML(data.title))
