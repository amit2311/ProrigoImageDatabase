...
albums.load = function() {
	...
	ProrigoGallery.animate('.content', 'contentZoomOut')
	...
	if (albums.json===null) {
		...
		api.post('Albums::get', {}, function(data) {
			...
			// Smart Albums
			if (ProrigoGallery.publicMode===false) albums._createSmartAlbums(data.smartalbums)
			...
			if (visible.album() && ProrigoGallery.content.html()==='')             waitTime = 0
...
albums.parse = function(album) {
	...
	if (album.password==='1' && ProrigoGallery.publicMode===true) {
