...
final class Config {
	 ...
	 */
	public static function create($host, $user, $password, $name = 'ProrigoGallery', $prefix = '') {
...
?>";
		...
		// Save file
		if (@file_put_contents(ProrigoGallery_CONFIG_FILE, $config)===false) return 'Warning: Could not create file!';
	...
	public static function exists() {
		...
		return file_exists(ProrigoGallery_CONFIG_FILE);
