...
use ProrigoGallery\Access\Installation;
use ProrigoGallery\Access\Admin;
use ProrigoGallery\Access\Guest;
...
if (!empty($fn)) {
	...
	if (Config::exists()===false) {
		...
		/**
		 * Installation Access
		 * Limited access to configure ProrigoGallery. Only available when the config.php file is missing.
		 */
	...
	if ((isset($_SESSION['login'])&&$_SESSION['login']===true)&&
		...
		/**
		 * Admin Access
		 * Full access to ProrigoGallery. Only with correct password/session.
		 */
		...
		/**
		 * Guest Access
		 * Access to view all public folders and photos in ProrigoGallery.
		 */
